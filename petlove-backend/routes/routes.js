...
const bearerAuth = require('../src/middlewares/bearer')
const permissions = require('../src/middlewares/acl.js')
...
authRouter.delete('/users/:id', bearerAuth, permissions('deleteUser'), async (req, res, next) => {
